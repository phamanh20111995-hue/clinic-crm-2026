...
class Customer(models.Model):
    ...
    tele = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True,
        on_delete=models.SET_NULL, related_name='tele_customers',
...
class CustomerImage(models.Model):
    ...
    IMAGE_TYPE_CHOICES = [
        ('truoc', 'Trước ĐT'), ('trong', 'Trong ĐT'),
        ('sau', 'Sau ĐT'), ('tinh_trang', 'Tình trạng'),
    ]
...
class CallHistory(models.Model):
    ...
    tele = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True)
