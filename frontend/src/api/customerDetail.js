...
export const getCustomerContracts= (id)       => api.get('/api/contracts/', { params: { customer: id, page_size: 100 } })
export const getCustomerAppts   = (id)        => api.get('/api/appointments/', { params: { customer: id, page_size: 200 } })
